...
const HeaderMain = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-700 border-t-2 via-blue-500 to-blue-300 border-b border-gray-200 py-6">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center px-4 sm:px-6 lg:px-8">
        {/* Logo */}
        <div className="font-bold text-3xl sm:text-4xl text-center  sm:text-left pb-4 sm:pb-0  text-gray-900">
          <span className="text-4xl text-white">Small</span><span className="italic">Shop</span>
        </div>
        ...
        <div className="flex gap-6 text-gray-900 text-2xl">
          ...
          <div className="relative cursor-pointer hover:text-indigo-200">
            <FiHeart />
            <div
              className="bg-white rounded-full absolute top-0 right-0 w-[18px] h-[18px] text-[12px] text-gray-900 flex items-center justify-center translate-x-1 -translate-y-1"
            >
              0
            </div>
          </div>
